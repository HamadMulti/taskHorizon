...
from controllers.user_controller import change_team_member_password, create_team_member, delete_user, get_assigned_to, get_profile, get_profiles, subscribe_user, update_profile, updates_profile
...
user_bp.route("/assigned/<int:user_id>", methods=["GET"])(get_assigned_to)
