    ...
    <header className="flex shadow-md py-1 px-4 sm:px-7 bg-white min-h-[70px] tracking-wide z-[110] fixed top-0 w-full">
      <div className="flex flex-wrap items-center justify-between gap-4 w-full relative">
        <div className="flex items-center gap-6">
          ...
          <div className="max-md:max-sm:hidden !mr-7 outline-none">
            <Breadcrumbs />
          </div>
        </div>
              ...
              <div className="dropdown-menu relative flex shrink-0 group">
                {loading ? (
                  <>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="w-9 h-9 max-lg:w-16 max-lg:h-16 cursor-pointer animate-[spin_0.8s_linear_infinite] fill-yellow-600 block mx-auto"
                      viewBox="0 0 24 24"
                    >
                      <path
        ...
        <button
          id="toggleOpen"
          className="hidden !ml-7 outline-none "
          onClick={toggleMenu}
        >
          <svg
            className="w-7 h-7"
        ...
        <button
          onClick={logoutUser}
          className={`text-sm w-fit !ml-7 text-gray-800 flex !justify-center !item-center lg:hidden cursor-pointer p-2 rounded-md hover:bg-[#0C172C] hover:text-gray-100 transition duration-300 ease-in-out`}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="w-4 h-4 mr-3 fill-current"
