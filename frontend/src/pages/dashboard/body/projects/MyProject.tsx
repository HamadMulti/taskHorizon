...
import DeleteModal from "../../../components/modals/task/delete";
import { useDispatch, useSelector } from "react-redux";
import { AppDispatch, RootState } from "../../../../app/store";
import { fetchTasksDetails } from "../../../../features/taskSlice";
    ...
    <>
      <div className="overflow-x-auto">
        <div className="min-w-full bg-white flex items-center justify-between py-4 px-6">
          <h3 className="text-yellow-600 text-md font-bold px-4">My Tasks</h3>
          <button
          ...
          >
            ...
            {/* <span className="p-4 text-sm text-white">Task</span> */}
          </button>
          {isCreating && (
            <CreateTaskModal onSave={handleSave} onClose={handleClose} />
          )}
        </div>
          ...
          <tbody className="whitespace-nowrap">
            <tr className="even:bg-yellow-50">
              ...
              <td className="p-4">
                ...
                <DeleteModal task={currentTask} onDelete={handleClose} />
              </td>
            </tr>
          </tbody>
        </table>
