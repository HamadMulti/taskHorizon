            ...
            <div className="grid md:grid-cols-2 justify-center items-center gap-10">
              <div className="max-md:order-1">
                ...
                <p className="mt-4 text-base leading-relaxed">
                  Stay organized, prioritize effortlessly, and conquer deadlines
                  with <strong>TaskHorizon</strong>. The ultimate task
                  management system designed to keep you focused, efficient, and
                  always ahead. Whether you're managing personal projects or
                  leading a team, <strong>TaskHorizon</strong> helps you
                  streamline tasks, collaborate seamlessly, and turn goals into
                  achievements.
                </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-14">
                <div className="bg-white cursor-pointer rounded-md overflow-hidden group">
                  <div className="relative overflow-hidden">
                    ...
                    />
                    <div className="px-4 py-2.5 text-white bg-yellow-600 absolute bottom-0 right-0">
                      June 10, 2023
                    </div>
                  </div>
                  <div className="p-6">
                    ...
                    <button
                      type="button"
                      className="bg-yellow-600 hover:bg-yellow-700 text-white rounded-full px-5 py-2.5 mt-6 transition-all"
                    >
                      Read More
                    </button>
                  </div>
